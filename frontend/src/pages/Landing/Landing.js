        ...
        `}
                ...
                <div className="flex justify-center w-full max-md:scale-50">
                    <div className="w-[1063px] h-[250px] top-[615px] absolute max-md:top-[750px] flex items-center justify-center">
                        ...
                        <h1 className="absolute left-[190px] top-[25px] text-white text-[54px] whitespace-normal">Prepare, Respond, Recover</h1>
                        <h1 className="absolute left-[120px] top-[125px] text-black text-[54px] whitespace-normal">Together Through Tough Times</h1>
