...
const TopBar = () => {
    return(
        <div className={"flex justify-between w-full bg-[#000000] border-b-2 border-b-light-gray h-14"}>
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
                ...
                <input className={"bg-transparent border-none outline-none placeholder-white"} placeholder={"Search Activities"}/>
            </div>
